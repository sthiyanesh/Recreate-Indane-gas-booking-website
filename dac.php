...
<body>
	...
	<h2 style = "color:green;text-align:center"><?php
			if(isset($_GET['bstatus'])){
				echo "The DAC Number was set Successfully.";
			}
		?></h2>
	<div class = "container vh-100">
		...
		<div class = "card text-center w-25 my-auto shadow">
			...
			<div class = "card-body">
				<form action = "dac1.php" method = "post">
					<div class = "form-group">
						<label for = "box1" >BOOKING ID</label>
						<input type= "number" id = "box1" class = "form-control" name = "bid" required />
					</div>
					<div class = "form-group">
						<label for = "box2" >AGENCY ID</label>
						<input type= "text" id = "box2" class = "form-control" name = "aid" required />
					</div>
					<div class = "form-group">
						<label for = "box3" >AGENCY DOB</label>
						<input type= "date" id = "box3" class = "form-control" name = "dob" required />
					</div>
					<div class = "form-group">
						<label for = "box4" >DAC NUMBER</label>
						<input type= "text" id = "box4" class = "form-control" name = "new" required />
					</div>
				</div>
				<div class = "card-body">
					<input type = "submit" class = "btn btn-primary w-100" value = "Set DAC" name = "" />
				</div>
			</form>
		</div>
		</div>
