...
<body>
	...
	<h2 style = "color:green;text-align:center"><?php
			if(isset($_GET['bstatus'])){
				echo "Successfully removed the Booking From The Table";
			}
		?></h2>
	<div class = "container vh-100">
		...
		<div class = "card text-center w-25 my-auto shadow">
			...
			<div class = "card-body">
				<form action = "delivered1.php" method = "post">
				...
				<div class = "card-body">
					<input type = "submit" class = "btn btn-primary w-100" value = "Delivered" name = "" />
				</div>
			</form>
		</div>
		</div>
