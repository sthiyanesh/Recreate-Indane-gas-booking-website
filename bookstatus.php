	...
	<div class = "container vh-100">
		...
		<div class = "card text-center w-25 my-auto shadow">
			<div class = "card-header bg-primary text-white">
				CHECK YOUR BOOKED CYLINDER STATUS
			</div>
			<div class = "card-body">
				<form action = "bookstatus1.php" method = "post">
					<div class = "form-group">
						<label for = "box1" >BOOKING ID</label>
						<input type= "number" id = "box1" class = "form-control" name = "bid" required />
					</div>
					<div class = "form-group">
						<label for = "box2" >CONSUMER ID</label>
						<input type= "text" id = "box2" class = "form-control" name = "cid" required />
					</div>
					<div class = "form-group">
						<label for = "box3" >CONSUMER NAME</label>
						<input type= "text" id = "box3" class = "form-control" name = "name" required />
					</div>
				</div>
				<div class = "card-body">
					<input type = "submit" class = "btn btn-primary w-100" value = "Check Status" name = "" />
				</div>
			</form>
		</div>
		</div>
