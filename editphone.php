...
<body>
	...
	<h2 style = "color:green;text-align:center"><?php
			if(isset($_GET['bstatus'])){
				echo "The Consumer Phone Number changed Successfully.";
			}
		?></h2>
	<div class = "container vh-100">
		...
		<div class = "card text-center w-25 my-auto shadow">
			...
			<div class = "card-body">
				<form action = "editphone1.php" method = "post">
					...
					<div class = "form-group">
						<label for = "box4" >NEW CONSUMER PHONE NO.</label>
						<input type= "number" id = "box4" class = "form-control" name = "new" required />
					</div>
				</div>
				<div class = "card-body">
