...
<body>
	...
	<div class = "container vh-100">
		...
		<div class = "card text-center w-50 my-auto shadow">
			...
			<div class = "card-body">
				<h4>Your 17 Digit ID is <?php echo $_GET["lpgid"]; ?></h4>
			</div>
		<center>
			<a href="http://localhost/miniproject/homenolog.html" class="btn btn-primary btn-lg btn-block" role="button">Back To Home</a>
		</center>
		</div></div>	
	</div>
